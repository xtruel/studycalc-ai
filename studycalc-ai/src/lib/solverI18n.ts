...
export const PACKS: Record<Lang, Labels> = {
  it: {
    ...
    img: [
      "Ho letto la foto direttamente sul dispositivo (gratis e offline), ma non ho riconosciuto un'espressione o un'equazione chiara. Riprova con una foto più nitida e ben inquadrata, oppure scrivi l'esercizio qui sotto.",
    ...
    gen_recognized_img: "Foto letta sul dispositivo, ma non ho riconosciuto un calcolo da risolvere. Prova con una foto più nitida o scrivi l'esercizio.",
  ...
  en: {
    ...
    img: [
      "I read the photo directly on your device (free and offline), but couldn't make out a clear expression or equation. Try a sharper, well-framed photo, or type the exercise below.",
    ...
    gen_recognized_img: "Photo read on your device, but I couldn't recognize a calculation to solve. Try a clearer photo or type the exercise.",
  ...
  es: {
    ...
    img: [
      "Leí la foto directamente en tu dispositivo (gratis y sin conexión), pero no reconocí una expresión o ecuación clara. Prueba con una foto más nítida y bien encuadrada, o escribe el ejercicio abajo.",
    ...
    gen_recognized_img: "Foto leída en tu dispositivo, pero no reconocí un cálculo que resolver. Prueba con una foto más nítida o escribe el ejercicio.",
  ...
  fr: {
    ...
    img: [
      "J'ai lu la photo directement sur ton appareil (gratuit et hors ligne), mais je n'ai pas reconnu d'expression ou d'équation claire. Réessaie avec une photo plus nette et bien cadrée, ou saisis l'exercice ci-dessous.",
    ...
    gen_recognized_img: "Photo lue sur ton appareil, mais je n'ai pas reconnu de calcul à résoudre. Essaie une photo plus nette ou saisis l'exercice.",
  ...
  de: {
    ...
    img: [
      "Ich habe das Foto direkt auf deinem Gerät gelesen (kostenlos und offline), aber keinen klaren Ausdruck und keine Gleichung erkannt. Versuch es mit einem schärferen, gut ausgerichteten Foto oder tippe die Aufgabe unten ein.",
    ...
    gen_recognized_img: "Foto auf deinem Gerät gelesen, aber keine lösbare Rechnung erkannt. Versuch ein schärferes Foto oder tippe die Aufgabe ein.",
  ...
  pt: {
    ...
    img: [
      "Li a foto diretamente no teu dispositivo (grátis e offline), mas não reconheci uma expressão ou equação clara. Tenta uma foto mais nítida e bem enquadrada, ou escreve o exercício abaixo.",
    ...
    gen_recognized_img: "Foto lida no teu dispositivo, mas não reconheci um cálculo para resolver. Tenta uma foto mais nítida ou escreve o exercício.",
